...
# cloneall.sh
# Terminal script to execute 'git clone' on all my public GitHub repositories 
# to clone them into current OS X directory
...
git clone https://github.com/SteveCaine/unix-scripts.git
